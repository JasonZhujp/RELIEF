...
class H_PPO():
    def __init__(self, gnn: PromptedGNN, ensemble_num, penalty_alpha_d, penalty_alpha_c, emb_dim, max_num_nodes, max_action, init_log_std,
    ...
    def eval_prompt(self, batch_data, nodes_per_graph, step, truncate_flag):
        ...
        with torch.no_grad():
            ...
            # discrete action (When evaluating the policy, we still sample actions based on the probability to provide more flexible prompting policy)
